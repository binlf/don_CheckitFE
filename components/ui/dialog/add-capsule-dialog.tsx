...
export const AddCapsuleDialog = ({ children }: PropsWithChildren) => {
  return (
    <Dialog>
      <DialogTrigger asChild>{children}</DialogTrigger>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Add Capsule</DialogTitle>
          <DialogDescription>Add a new capsule entry</DialogDescription>
        </DialogHeader>
        <AddCapsuleForm />
      </DialogContent>
    </Dialog>
